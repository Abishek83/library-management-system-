...
# Sample data files
BOOKS_DATA = """book_id,title,author,isbn,available
1,The Great Gatsby,F. Scott Fitzgerald,9780743273565,True
2,To Kill a Mockingbird,Harper Lee,9780446310789,False
3,1984,George Orwell,9780451524935,True
4,Pride and Prejudice,Jane Austen,9780141439513,False
5,The Catcher in the Rye,J.D. Salinger,9780316769488,True"""

RESERVATIONS_DATA = """reservation_id,member_id,book_id,reservation_date
1,1,2,2023-04-12
2,3,4,2023-04-10"""

MEMBERS_DATA = """member_id,name,contact
...
class LibraryManager:
    ...
    def load_reservations(self):
        reservations = []
        reservation_data = StringIO(RESERVATIONS_DATA)
        reader = csv.reader(reservation_data)
        next(reader)  # Skip header row
        for row in reader:
    ...
    def load_members(self):
        members = []
        member_data = StringIO(MEMBERS_DATA)
